...
CREATE TABLE
    "p_tweet_comment_thumbs" (
        ...
        -- 评论类型 0为推文评论、1为评论回复
        "is_thumbs_up" integer NOT NULL DEFAULT 0,
        -- 是否点赞 0 为否 1为是
        "is_thumbs_down" integer NOT NULL DEFAULT 0,
        -- 是否点踩 0 为否 1为是
        "created_on" integer NOT NULL DEFAULT 0,
        "modified_on" integer NOT NULL DEFAULT 0,
        "deleted_on" integer NOT NULL DEFAULT 0,
...
CREATE INDEX
    "idx_attachment_user_id" ON "p_attachment" ("user_id" ASC);
...
CREATE INDEX
    "idx_captcha_expired_on" ON "p_captcha" ("expired_on" ASC);

CREATE INDEX "idx_captcha_phone" ON "p_captcha" ( "phone" ASC );

CREATE INDEX
    "idx_captcha_use_times" ON "p_captcha" ("use_times" ASC);
...
CREATE INDEX
    "idx_comment_post_id" ON "p_comment" ("post_id" ASC);

CREATE INDEX
    "idx_comment_user_id" ON "p_comment" ("user_id" ASC);
...
CREATE INDEX
    "idx_comment_content_comment_id" ON "p_comment_content" ("comment_id" ASC);

CREATE INDEX
    "idx_comment_content_sort" ON "p_comment_content" ("sort" ASC);

CREATE INDEX
    "idx_comment_content_type" ON "p_comment_content" ("type" ASC);

CREATE INDEX
    "idx_comment_content_user_id" ON "p_comment_content" ("user_id" ASC);
...
CREATE INDEX
    "idx_comment_reply_comment_id" ON "p_comment_reply" ("comment_id" ASC);
...
CREATE INDEX
    "idx_comment_metric_comment_id_rank_score" ON "p_comment_metric" (
        "comment_id" ASC,
        "rank_score" ASC
    );
...
CREATE INDEX
    "idx_tweet_comment_thumbs_uid_tid" ON "p_tweet_comment_thumbs"("user_id" ASC, "tweet_id" ASC);
...
CREATE INDEX
    "idx_following_user_follow" ON "p_following" ("user_id" ASC, "follow_id" ASC);
...
CREATE UNIQUE INDEX "idx_contact_user_friend" ON "p_contact" ("user_id" ASC, "friend_id" ASC);

CREATE INDEX
    "idx_contact_user_friend_status" ON "p_contact" (
        "user_id" ASC,
        "friend_id" ASC,
        "status" ASC
    );
...
CREATE INDEX
    "idx_message_is_read" ON "p_message" ("is_read" ASC);

CREATE INDEX
    "idx_message_receiver_user_id" ON "p_message" ("receiver_user_id" ASC);

CREATE INDEX "idx_message_type" ON "p_message" ( "type" ASC );
...
CREATE INDEX "idx_post_user_id" ON "p_post" ( "user_id" ASC );

CREATE INDEX
    "idx_post_visibility" ON "p_post" ("visibility" ASC);
...
CREATE INDEX
    "idx_post_metric_post_id_rank_score" ON "p_post_metric" ("post_id" ASC, "rank_score" ASC);
...
CREATE INDEX
    "idx_post_attachment_bill_post_id" ON "p_post_attachment_bill" ("post_id" ASC);

CREATE INDEX
    "idx_post_attachment_bill_user_id" ON "p_post_attachment_bill" ("user_id" ASC);
...
CREATE INDEX
    "idx_post_collection_post_id" ON "p_post_collection" ("post_id" ASC);

CREATE INDEX
    "idx_post_collection_user_id" ON "p_post_collection" ("user_id" ASC);
...
CREATE INDEX
    "idx_post_content_post_id" ON "p_post_content" ("post_id" ASC);

CREATE INDEX
    "idx_post_content_user_id" ON "p_post_content" ("user_id" ASC);
...
CREATE INDEX
    "idx_post_star_post_id" ON "p_post_star" ("post_id" ASC);

CREATE INDEX
    "idx_post_star_user_id" ON "p_post_star" ("user_id" ASC);
...
CREATE UNIQUE INDEX "idx_tag" ON "p_tag" ( "tag" ASC );

CREATE INDEX "idx_tag_quote_num" ON "p_tag" ( "quote_num" ASC );

CREATE INDEX "idx_tag_user_id" ON "p_tag" ( "user_id" ASC );
...
CREATE INDEX "idx_user_phone" ON "p_user" ( "phone" ASC );

CREATE UNIQUE INDEX "idx_user_username" ON "p_user" ("username" ASC);
...
CREATE INDEX
    "idx_user_metric_user_id_tweets_count_trends" ON "p_user_metric" (
        "user_id" ASC,
        "tweets_count" ASC,
...
CREATE INDEX
    "idx_wallet_recharge_trade_no" ON "p_wallet_recharge" ("trade_no" ASC);

CREATE INDEX
    "idx_wallet_recharge_trade_status" ON "p_wallet_recharge" ("trade_status" ASC);

CREATE INDEX
    "idx_wallet_recharge_user_id" ON "p_wallet_recharge" ("user_id" ASC);
...
CREATE INDEX
    "idx_wallet_statement_user_id" ON "p_wallet_statement" ("user_id" ASC);
